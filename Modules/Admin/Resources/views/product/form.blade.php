 ...
 <!--    <div class="form-group">
      <label for="name">Mô tả ngắn về sản phẩm:</label>
       <textarea  name="" class="form-control" cols="30" rows="3" placeholder="Mô tả ngắn "  >
       </textarea>       
    </div> -->
    <div class="form-group shadow-textarea">
    <label for="name">Mô tả :</label>
    <textarea class="form-control z-depth-1" name="pro_description" cols="30" rows="3" placeholder="Mô tả ngắn về sản phẩm">{{old('pro_description',isset($product->pro_description) ? $product->pro_description:'')}}</textarea>
    ...
    <textarea class="form-control z-depth-1" name="pro_content" id="pro_content" cols="30" rows="3" placeholder="Nội dung">{!!old('pro_content',isset($product->pro_content) ? $product->pro_content:'')!!}</textarea>
...
<div class="form-group">
      <img id="out_img" src="{{asset('images/no_image.jpg')}}"alt="" height="300" width="100%">
    </div>
