 ...
 <!--    <div class="form-group">
    ...
    <textarea class="form-control z-depth-1" name="a_description" cols="30" rows="3" placeholder="Mô tả bài viết">{{old('a_description',isset($article->a_description) ? $article->a_description:'')}}</textarea>
    ...
    <textarea class="form-control z-depth-1" name="a_content" cols="30" rows="3" placeholder="Nội dung">{{old('a_content',isset($article->a_content) ? $article->a_content:'')}}</textarea>
