...
<div class="row">
  <div class="col-sm-12">
    ...
    <div class="form-group">
      ...
      <input type="email" disabled="" class="form-control" id="email" placeholder="Enter email" name="email" value="{{$user->email}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control z-depth-1" name="about"   cols="30" rows="5" placeholder="Mô tả bản thân">{{$user->about}}</textarea>
    </div>
